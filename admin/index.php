...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <!-- Navbar Brand-->
        <a class="navbar-brand ps-3" href="index.html">Norton Coffee Admin</a>
        <!-- Sidebar Toggle-->
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Dashboard Coffee Admin</h1>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item active">Admin Dashbord</li>
                    </ol>
                    <div class="row">
